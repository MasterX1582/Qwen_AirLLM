...
COPY airllm-3.0.0-py3-none-any.whl /tmp/airllm-3.0.0-py3-none-any.whl
RUN pip3 uninstall -y airllm || true && \
    pip3 install --no-cache-dir /tmp/airllm-3.0.0-py3-none-any.whl && \
    rm /tmp/airllm-3.0.0-py3-none-any.whl
